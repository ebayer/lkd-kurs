...
DATABASES = {
    'default': {
        ...
        'NAME': '/root/lkd-kurs/sqlite.db', # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/root/lkd-kurs/django-media-files/'
