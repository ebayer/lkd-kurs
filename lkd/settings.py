...
DATABASES = {
    'default': {
        ...
        'NAME': '/mnt/yedek/ebayer/yedek/workspace/dev/eclipse_projects/lkd/sqlite.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/home/ebayer/workspace/dev/eclipse_projects/lkd/kurs/static',
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/ebayer/workspace/dev/eclipse_projects/lkd/kurs/templates',
)
